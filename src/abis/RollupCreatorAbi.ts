export const RollupCreatorAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'validatorUtils', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_deployFactoriesToL2', type: 'bool' },
      { internalType: 'uint256', name: '_maxFeePerGasForRetryables', type: 'uint256' },
    ],
    name: 'createRollup',
