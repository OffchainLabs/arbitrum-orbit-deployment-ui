export const DocsPanel = () => {
  return (
    <div className="border-px hide-scrollbar flex h-full flex-col gap-5 overflow-y-scroll rounded-md border border-[#5E5E5E] bg-[#191919] p-2 text-sm leading-tight">
      ...
      <h2 className="text-lg font-light" id="chain-name">
        CHAIN NAME
      </h2>
      <p>
      ...
      <h2 className="text-lg font-light" id="owner">
        OWNER
      </h2>
      <p>
      ...
      <h2 className="text-lg font-light" id="gas-token">
        GAS TOKEN
      </h2>
      <p>
      ...
      <h2 className="text-lg font-light" id="validators">
        VALIDATORS
      </h2>
      <p>
      ...
      <h2 className="text-lg font-light" id="batch-poster">
